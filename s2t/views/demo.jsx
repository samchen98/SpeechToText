...
export default React.createClass({
  ...
  test(){
    ...
    var split = textContent.split("JSON")
    console.log(split[1]);


var nlp = require('compromise');
var t = nlp(split[1]).nouns();

console.log(t.out('text'))

//    var hiddenElement = document.createElement('a');
//  hiddenElement.href = 'data:attachment/text,' + encodeURI(split[1]);
      ...
      >
        ...
        <div className="flex buttons">
          ...
          <button className={buttonClass} onClick={this.handleSample1Click}>
            <Icon type={this.state.audioSource === 'asdfasdfasf' ? 'stop' : 'play'} /> Play Sample 1
          </button>

          <button className={buttonClass} onClick={this.test}>
            <Icon type={this.state.audioSource === 'sample-2' ? 'stop' : 'play'} />DOWNLOAD
          </button>
